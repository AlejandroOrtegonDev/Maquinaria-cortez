<template>
  <a
    ...
    @mouseenter="showPulse = true"
    @mouseleave="showPulse = false"
...
export default {
  ...
  setup() {
    ...
    const phoneNumber = ''; 
    const defaultMessage = encodeURIComponent('Hola, me gustaría obtener más información.');
...
.whatsapp-button.pulse {
  animation: pulse 1.5s ease-in-out infinite, slideIn 0.5s ease-out;
}
